                        ...
                        <div class="border p-3">
                            ...
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[{{$lang->code}}]" class="form-control" id="name" placeholder="{{ __('main.enter_name') }}" value="{{ isset($product->name) ? strip_tags($product->name) : '' }}">
