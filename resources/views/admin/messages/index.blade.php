                    ...
                    <table class="table table-bordered">
                        ...
                        @forelse($msgs as $index => $msg)
                            <tr>
                               ...
                               <td>
                                    {{ isset($msg->type) ? $msg->type : __('main.no_data') }}
                                </td>

                                <td>
                                    {{ isset($msg->product_name) ? $msg->product_name : __('main.no_data') }}
                                </td>

                                
                                <td>
                                    {{ isset($msg->company) ? $msg->company : __('main.no_data') }}
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('admin.messages.show', ['id' => $msg->id]) }}">
                                        <button class="btn btn-sm btn-info"> <i class="nav-icon fas fa-edit"></i> </button> <!-- Translation key for "Show" -->
                                    </a>

                                    <a href="{{ route('admin.messages.destroy', ['id' => $msg->id]) }}">
                                        <button class="btn btn-sm btn-danger"><i class="nav-icon fas fa-trash"></i> </button> <!-- Translation key for "Remove" -->
                                    </a>
                                </td>
                            </tr>
                        @empty
