...

{
    ...
    public function create()
    {
        ...
        return view('admin.parteners.add' , ['langs'=>$this->langs , 'categories'=>$categories]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.parteners.edit' , ['partener'=>$partener , 'langs'=>$this->langs , 'categories'=>$categories]);
    ...
    public function store (OurPartenerRequest $request)
    {
        ...
        try{
            ...
            // need to store categories ids in json format
            if($request->has('cats') && !empty($request->cats)){
                $categories = [];
                foreach ($request->cats as $category) {
                    $categories[] = $category;
                }
            }
            $request->merge(['cats' => json_encode($categories)]);
            $partener = Partener::create(['icon'=>$image_name , 'categories' => $request->cats]);
    ...
    public function update(OurPartenerRequest $request , $id)
    {
        try{
            ...
            if($request->has('icon')){
                ...
                $partener->categories = $request->cats;
            }
